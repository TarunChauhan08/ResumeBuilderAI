...
bg-gradient-to-br from-purple-300 to-indigo-500 text-white rounded-full"
            />
            <p
...
hidden">
                  <TrashIcon onClick={(e)=>{e.stopPropagation(); deleteResume(resume._id)}}
                    className="size-7 p-1.5 hover:bg-white/50 rounded
text-slate-700 transition-colors"
                  />
                  <PencilIcon onClick={(e)=>{e.stopPropagation(); setEditResumeId(resume._id); setTitle(resume.title)}}
                    className="size-7 p-1.5 hover:bg-white/50 rounded
text-slate-700 transition-colors"
                  />
                </div>
...
z-10 flex items-center justify-center">
            <div onClick={e=>e.stopPropagation()} className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6">
              ...
              <input onChange={(e)=>setTitle(e.target.value)} value={title}
                ...
                className="w-full
px-4 py-2 mb-4 border border-slate-300 rounded focus:outline-none focus:border-green-600 focus:ring-1 focus:ring-green-600"
                required
              />
...
px-4 py-2 mb-4 border border-slate-300 rounded focus:outline-none focus:border-green-600 focus:ring-1 focus:ring-green-600"
              ...
              <div>
                ...
                <label htmlFor="resume-input" className='flex flex-col items-center justify-center gap-2
